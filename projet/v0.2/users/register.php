...
<form action="register.php" method="post">
    ...
    <input type="text" id="password" class="fadeIn second" name="password_confirm" placeholder="Confirmation mot de passe" required>
    <input type="submit" class="fadeIn fourth" name="register" value="Créer son compte">
</form>
        <div id="formFooter">
            <a class="underLineHover" style="color: red"><?php if (isset($_GET['info'])){ $info = $_GET['info']; } else { $info = ""; } if ($info == 1){ echo "Vos mots de passes ne correspondent pas !"; } ?></a>
