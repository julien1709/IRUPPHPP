...
if(isset($_POST['login'])){
    ...
    $sql = "SELECT id, prenom, nom, username, password, email, phone FROM users WHERE username = :username";
...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <!-- Remind Passowrd -->
        <div id="formFooter">
            <a class="underLineHover" style="color: red"><?php if (isset($_GET['info'])) { $info = $_GET['info']; } else { $info = ""; } if ($info == 1){ echo "Erreur de nom d'utilisateur ou de mot de passe"; }elseif ($info == 2){ echo "Erreur de nom d'utilisateur ou de mot de passe"; } ?></a>
